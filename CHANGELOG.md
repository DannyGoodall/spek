...
- Opt in via the VS Code setting `spek.aggregateJjWorkspaces` (**experimental, off by default**) or the Web `jj` query param + the "Include jj workspaces (experimental)" checkbox — independent of git worktree aggregation
